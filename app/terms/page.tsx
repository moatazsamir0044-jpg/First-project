...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://birdnestlife.com/terms' },
}
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="container-site max-w-3xl py-16 space-y-12">
          ...
          {/* Discounts */}
          <section>
            <h2 className="font-heading text-2xl text-[#292a2b] mb-4">Discounts</h2>
            <p className="text-[#292a2b]/70 leading-relaxed">We offer daily rates, weekly discounts, and monthly discounts depending on duration of stay. Contact us for details.</p>
          </section>
